    ...
    <div>
      <section>
        <h1 className="text-center my-4 text-5xl font-bold">
          <span className="font-extrabold">Bringing</span> Hope, <span className="font-extrabold">Changing</span> Lives
        </h1>
        <p className="text-[#636363] text-lg text-center">From Barefoot Beginnings to Boundless Destinations,</p>
        <p className="text-[#636363] text-lg text-center">A journey of Hope, Resilience and Transformation</p>
